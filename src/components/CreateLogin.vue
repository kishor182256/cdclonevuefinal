<template>
    <div class="main">
      <div class="header_section">
        <h1 class="select">Create your login</h1>
        <p class="para">
            ...
            <p>Your password must contain:</p>
             <div class="passwordvalidation" >
              <div class="circle">
                ...
                <p class="passwordvalidationlable">at least 8 characters</p></div>
              <div class="circle">
                <i class="fa fa-genderless faiccon"></i>
                <p class="passwordvalidationlable">at least 1 number</p></div>
              <div class="circle">
                <i class="fa fa-genderless faiccon"></i>
                <p class="passwordvalidationlable">a lower case character</p></div>
              <div class="circle">
                <i class="fa fa-genderless faiccon"></i>
                <p class="passwordvalidationlable">a upper case character</p></div>
             </div>
          </div>
      ...
      <div><h3 class="referheading">Were you referred to us?</h3></div>
      <div class="radiobutton">
        ...
        <div class="radiobuttonlabel">
         ...
         <div class="radiobuttonlabelno">
          <div class="radiobuttonlabel"><input
            type="radio"
            name="radio"
            :value="true"
            v-model="websiteAccept"
     ...
     <div v-if="websiteAccept">
       ...
       <div><button type="button"
        @click="Redirect()"
         name="save" value="Save" class="accountbutton">
        Continue
      </button></div>
    </div>
  </template>
